...
import 'package:untitled3/shared/BlocObserver.dart';
...
Future<void> main() async {
  ...
  dark = Cachehelper.preferences.get('isDark');
  runApp(MyApp());
}
          ...
          builder: (context, state) => MaterialApp(
            ...
            theme: ThemeData(
              colorScheme: ColorScheme.fromSeed(
                  seedColor: Color.fromARGB(255, 152, 139, 239),
                  brightness: Brightness.light),
              scaffoldBackgroundColor: Colors.white,
              cardColor: Colors.white,
              appBarTheme: const AppBarTheme(
                color: Color.fromARGB(255, 83, 30, 230),
            ...
            initialRoute: "/Start",
            routes: {
              '/': (BuildContext context) => HomeLayout(),
              '/Start': (BuildContext context) => const StartScreen(),
            },
            debugShowCheckedModeBanner: false,
            themeMode: Todo_Cubit.get(context).isdark
                ? ThemeMode.dark
                : ThemeMode.light,
            darkTheme: ThemeData.dark().copyWith(
                colorScheme: ColorScheme.fromSeed(
                    seedColor: Color.fromARGB(255, 134, 65, 255),
